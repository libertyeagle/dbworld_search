...
%>
<%!
    Date add_date_by_one_day(Date orig_date) {
    ...
    String add_conference_result(DBWorldMessage message) {
        ...
        if (message.deadline.getTime() != 0) {
            content_builder.append(DATE_FORMAT.format(
                    add_date_by_one_day(message.deadline)));
        } else {
        ...
        if (message.conf_info.start_date.getTime() != 0) {
            content_builder.append(DATE_FORMAT.format(
                    add_date_by_one_day(message.conf_info.start_date)));
        } else {
            content_builder.append("N/A");
        }
        content_builder.append("<br>\n");
        ...
        if (message.conf_info.end_date.getTime() != 0) {
            content_builder.append(DATE_FORMAT.format(
                    add_date_by_one_day(message.conf_info.end_date)));
        } else {
            content_builder.append("N/A");
        }
        content_builder.append("<br>\n");
...
<div class="container">
    <div class="row align-items-center">
        <div class="col mt-3">
            <center>Page <span
                    style="color:#576574;font-weight:bold;"> <%=page_index + 1%> / <%=total_pages > 0 ? total_pages : 1%></span>
            </center>
        </div>
    </div>
    <div class="row align-items-center">
